...
*/
#include <Signal_Processing_inferencing.h>
...
void classify()
{
  ...
  for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
    ei_printf("    %s: \t%f\r\n", result.classification[ix].label, result.classification[ix].value);
                ...
                if ((result.classification[ix].label == "Go") && (result.classification[ix].value > 0.75))
                      {
                        digitalWrite(2, HIGH); //Green
                        digitalWrite(12, LOW); //Red
                        digitalWrite(15, LOW); //Blue
                       }
                if ((result.classification[ix].label == "Stop") && (result.classification[ix].value > 0.75))
                      {
                ...
                if ((result.classification[ix].label == "OK") && (result.classification[ix].value > 0.75))
                      {
